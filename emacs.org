...
#+BEGIN_SRC emacs-lisp
  (req-package hydra
    ...
    (defhydra hydra-motion (:body-pre (next-line))
      ...
      ("p" previous-line "↑")
      ("f" forward-char "→")
      ("a" sk/smarter-beginning-of-line "BoL")
...
Gives lots of nice customizability to the mode line.

#+BEGIN_SRC emacs-lisp
  (setq orig-mode-line mode-line-format)
  ...
  (defun custom-modeline-mode-icon ()
    (format " %s"
            (propertize (all-the-icons-icon-for-buffer)
                        ...
                        'face `(:foreground "dark olive green" :height 1.25 :family ,(all-the-icons-icon-family-for-buffer)))))
