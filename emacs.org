...
#+BEGIN_SRC emacs-lisp
  (req-package smartparens
    ...
    (add-hook 'smartparens-mode-hook
              '(lambda ()
                 (local-set-key (kbd "s-s s") #'sp-slurp-hybrid-sexp)
                 (local-set-key (kbd "s-s b") #'sp-backward-barf-sexp)
                 (local-set-key (kbd "s-s c") #'sp-split-sexp)
                 (local-set-key (kbd "s-s r") #'sp-raise-sexp))))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (req-package celestial-mode-line
    :config
                                   ...
                                   (concat
                                    (propertize text
                                                ...
                                                `(:foreground
                                                  ...
                                                  ,mode-line-font-height))
                                    " |")))
                             (propertize celestial-mode-line-string
                                         'face
                                         `(:foreground
                                           "CornflowerBlue"
                                           :height
