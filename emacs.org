...
#+BEGIN_SRC emacs-lisp
  (push `("B" "Business" entry
          (file ,(concat org-directory "jobs.org"))
...
For apartments (temporary)

#+BEGIN_SRC emacs-lisp
  (push `("a"
          "Apartment"
          entry
          (file ,(concat org-directory "apartments.org"))
          ,(concat "* %^{Name}\n"
                   ":PROPERTIES:\n"
                   ":URL:         %^{URL}\n"
                   ":ADDRESS:     %^{Address}\n"
                   ...
                   ":RENT:        %^{Rent ($/mo.)}\n"
                   ":SQFT:        %^{Area (sq. ft.)}\n"
                   ":BC_DISTANCE: %^{Distance to Beckman Coulter (mi.)}\n"
                   ":GG_DISTANCE: %^{Distance to Greenlight Guru (mi.)}\n"
                   ":END:\n"
                   "\n"
                   "Amenities:\n"
                   "\n"
